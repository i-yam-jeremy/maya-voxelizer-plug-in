...
const voxelizer::VoxelPointLine &
    voxelizer::VoxelPointPlane::operator[](int y) const {
  return this->lines[y];
}
...
const voxelizer::VoxelPointPlane &
    voxelizer::VoxelPointGrid::operator[](int x) const {
  return this->planes[x];
}
